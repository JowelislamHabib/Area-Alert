    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <div className="grid gap-8 md:grid-cols-3">
        {items.map((item, index) => (
          <Card 
            key={index} 
            className="group relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-card/50 backdrop-blur-sm border-muted"
          >
            ...
            <CardContent className="p-8 relative z-10">
              <div className={`mb-6 inline-flex h-12 w-12 items-center justify-center rounded-xl border ${item.bgColor} ${item.borderColor}`}>
