    ...
    <section className="py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center rounded-[var(--radius)] bg-primary/5 p-8 sm:p-12 lg:p-16 border border-primary/10 shadow-sm relative overflow-hidden">
          ...
          <div className="relative h-full min-h-[400px] w-full rounded-2xl overflow-hidden bg-gradient-to-br from-background via-muted/30 to-muted/50 border border-border flex items-center justify-center p-8 shadow-inner z-10">
