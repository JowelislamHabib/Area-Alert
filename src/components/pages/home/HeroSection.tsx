    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-primary/80">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          <StaggerContainer className="space-y-6 text-primary-foreground">
            <StaggerItem>
          ...
          <FadeIn delay={0.2} className="hidden lg:flex items-center justify-center">
            <div className="relative w-full max-w-md aspect-square">
              ...
              <div className="absolute bottom-28 -left-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 flex items-center gap-3 shadow-lg shadow-black/10 rotate-[2deg] hover:rotate-0 transition-transform duration-300">
              ...
              <div className="absolute bottom-12 right-8 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 flex items-center gap-3 shadow-lg shadow-black/10 rotate-[-2deg] hover:rotate-0 transition-transform duration-300">
              ...
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-4 flex items-center gap-3 shadow-lg shadow-black/10 rotate-[5deg] hover:rotate-0 transition-transform duration-300">
                <div className="flex size-12 items-center justify-center rounded-xl bg-indigo-400/20 text-indigo-300">
                  <Waves className="size-6" />
                </div>
                <div>
                  <p className="text-sm font-semibold text-white">Flood</p>
                  <p className="text-xs text-white/60">28 active reports</p>
                </div>
              </div>
