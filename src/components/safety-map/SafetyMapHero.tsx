        ...
        <div className="max-w-3xl">
          <FadeIn>
            ...
            <p className="text-primary-foreground/80 text-base md:text-lg mb-8 max-w-xl">
              See which districts and areas have the most active utility issues.
              Use this to make informed decisions about where to live, work, or
              visit.
            </p>
          </FadeIn>
          ...
          <StaggerContainer delay={0.2} className="flex flex-wrap gap-3">
            <StaggerItem>
              <div className="bg-primary-foreground/10 hover:bg-primary-foreground/20 transition-colors border border-primary-foreground/20 rounded-lg px-4 py-1.5 text-sm font-medium flex items-center">
                <strong className="mr-1.5">{safeCount}</strong> {activeType}{" "}
                currently safe
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="bg-primary-foreground/10 hover:bg-primary-foreground/20 transition-colors border border-primary-foreground/20 rounded-lg px-4 py-1.5 text-sm font-medium flex items-center">
                <strong className="mr-1.5">{activeCount}</strong> {activeType}{" "}
                with active issues
              </div>
            </StaggerItem>
            <StaggerItem>
              <div className="bg-primary-foreground/10 hover:bg-primary-foreground/20 transition-colors border border-primary-foreground/20 rounded-lg px-4 py-1.5 text-sm font-medium flex items-center">
                <strong className="mr-1.5">{activeOutages}</strong> active
                outages right now
              </div>
            </StaggerItem>
          </StaggerContainer>
